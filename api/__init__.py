...
class API:
    project_name="scarlet-api"
    def __init__(self):
        self.config=adisconfig('/opt/adistools/configs/scarlet-api.yaml')
        ...
        self.log.info('Starting initialization of scarlet-api')
        ...
        self.log.success('Initialisation of scarlet-api succeed')
